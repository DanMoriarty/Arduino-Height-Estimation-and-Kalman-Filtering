...
//acceleration
  ...
  //HEIGHT FILTERING
    //Predicted X
  double x1pred = A[0][0]*x1 + A[0][1]*x2 + B[0][0]*U;//A[0][2]*x3 + B[0][0]*U;
  double x2pred = A[1][0]*x1 + A[1][1]*x2 + B[0][1]*U;//A[1][2]*x3 + B[1][0]*U;
...
double    x =predX-L*(CCC*predX-relalt);
    x = CCC*x;    
