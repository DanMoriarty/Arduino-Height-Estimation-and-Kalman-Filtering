...
//    Serial.print(alt0);
//    Serial.print(" ");
//    Serial.print(initflush);
      
    zValue=faultdetect(zValue1,zValue2, zValue,alt,lastalt);
    
    //bias correction
    //zValue2 = zValue2+initbiasdif;
    
    //double zValue = zValue1;//delete this for fault detect
...
//    Serial.print(", ");
    ...
    double c1 = 0.5;
    double c2 = 0.9;
    double dif = (c1*(x1pred-x1predprev)+c2*(alt-lastalt))/(c1+c2);
    x1pred =x1predprev+dif;
    } else {
      x1pred = alt;
    }
